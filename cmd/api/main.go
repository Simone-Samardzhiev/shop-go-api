...
func (a *API) start() error {
	...
	adminGroup.Get("/users-info", a.Handlers.UserHandler.GetUsers())
	adminGroup.Get("/user-info/:id", a.Handlers.UserHandler.GetUserById())
	adminGroup.Get("/users-info-by-email/:email", a.Handlers.UserHandler.GetUserByEmail())
	adminGroup.Get("/users-info-by-username/:username", a.Handlers.UserHandler.GetUserByUsername())
	adminGroup.Delete("/delete-user/:id", a.Handlers.UserHandler.DeleteUser())
	adminGroup.Patch("/force-logout-user/:id", a.Handlers.UserHandler.ForceLogoutUser())
	adminGroup.Patch("/update-email", a.Handlers.UserHandler.UpdateUserEmail())
	adminGroup.Patch("/update-username", a.Handlers.UserHandler.UpdateUserUsername())
	adminGroup.Patch("/update-role", a.Handlers.UserHandler.UpdateUserRole())
	adminGroup.Patch("/update-password", a.Handlers.UserHandler.UpdateUserPassword())
